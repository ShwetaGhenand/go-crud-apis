...
func TestCreateUserEndpoints(t *testing.T) {
	...
	t.Run("Succeed if valid user passed", func(t *testing.T) {
		...
		require.NotNil(t, user.GetCreateTime())
		require.NotNil(t, user.GetUpdateTime())
	})
...
func TestUpdateUserEndpoints(t *testing.T) {
	...
	t.Run("Failed if invalid email passed", func(t *testing.T) {
		// Act
		user, err := service.UpdateUser(context.Background(), &userspb.UpdateUserRequest{Id: 2, User: &userspb.User{Email: "abc.com"}})
		// Assert
		require.Error(t, err)
		require.Nil(t, user)
		st, ok := status.FromError(err)
		...
		require.Equal(t, "invalid email", st.Message())
	})

	t.Run("Failed if user does not exits", func(t *testing.T) {
		// Act
		user, err := service.UpdateUser(context.Background(), &userspb.UpdateUserRequest{Id: 2})
		// Assert
		require.Error(t, err)
		require.Nil(t, user)
		st, ok := status.FromError(err)
...
func TestDeleteUserEndpoints(t *testing.T) {
	...
	t.Run("Failed if user does not exits", func(t *testing.T) {
		// Act
		user, err := service.DeleteUser(context.Background(), &userspb.DeleteUserRequest{Id: 2})
		// Assert
		require.Error(t, err)
		require.Nil(t, user)
		st, ok := status.FromError(err)
